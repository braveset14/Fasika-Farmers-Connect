CREATE TABLE health_advisories (
    ...
    category           VARCHAR(50) NOT NULL,   -- e.g. 'Nutrition', 'Disease Prevention', 'Sanitation'
    event_type         VARCHAR(50),            -- e.g. 'Outbreak', 'Campaign', 'Seasonal Alert'
    season_id          INT REFERENCES seasons(season_id),

    title              VARCHAR(100) NOT NULL,  -- Short headline for the advisory
    advice             TEXT NOT NULL,          -- Detailed guidance for communities
    ...
    recommended_action TEXT,                   -- Practical steps for households/communities
