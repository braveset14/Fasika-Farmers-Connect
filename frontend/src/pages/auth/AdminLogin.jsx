...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setTimeout(() => {
            login({ name: "Admin User", role: "admin" }, "admin-token-123");
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-[#0d160f] border border-purple-500/20 rounded-3xl p-10 shadow-2xl shadow-purple-500/5">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-white leading-tight">Admin Portal</h2>
                            <p className="text-xs font-bold text-purple-400 uppercase tracking-widest">Restricted Access</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Security Token</label>
                            <div className="relative">
                    ...
                    <div className="mt-8 pt-8 border-t border-[#1a231c] text-center">
                        <p className="text-sm text-gray-500 mb-4 font-medium italic">Need to register a new admin account?</p>
                        <Link to="/admin/register" className="text-purple-400 font-bold hover:underline underline-offset-4">
                ...
                <p className="mt-10 text-center text-[10px] text-gray-600 uppercase tracking-[0.2em] font-black">
                    Security Level 4 • End-to-End Encrypted
                </p>
            </div>
        </div>
    );
